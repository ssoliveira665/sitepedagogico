# Generated by Django 5.1.1 on 2024-10-06 19:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pendente'), ('approved', 'Aprovado'), ('rejected', 'Rejeitdo(a)')], default='pending', max_length=20)),
                ...
                ('disciplinas', models.ManyToManyField(blank=True, to='website.disciplina', verbose_name='Qual(is) disciplina(s) deseja realizar a prova')),
            ],
        ),
    ]
